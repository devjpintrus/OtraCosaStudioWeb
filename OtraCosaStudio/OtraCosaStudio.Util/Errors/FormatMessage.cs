...
{ 
    internal class FormatMessage
    {
        /* ATRIBUTOS */
        private StringBuilder dataAdds = new StringBuilder();
        ...
        public override string ToString()
        {
            string resultado = string.Format(
                    ...
                    "[Datos Adicionales]\r\n" +
                    "{3}",
                    Titulo.Replace("\"", "\\\""), Detalle, Acciones, dataAdds.ToString());
        ...
        {
            dataAdds.Append(string.Format("{0}=\"{1}\"\r\n", nombre, valor));
        }
